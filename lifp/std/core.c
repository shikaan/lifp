...
result_value_ref_t sum(const value_array_t *arguments, position_t pos) {
  ...
  return valueCreate(VALUE_TYPE_NUMBER, (value_as_t){.number = sum}, pos);
}
...
result_value_ref_t subtract(const value_array_t *arguments, position_t pos) {
  ...
  number_t result_value = first.as.number;
...
//  */
// const char *MUL = "*";
// result_void_position_t multiply(value_t *result, const value_list_t
// *arguments,
//                                 arena_t *arena) {
//   (void)arena;
//   number_t product = 1;
...
// result_void_position_t lessThan(value_t *result, const value_list_t
// *arguments,
//                                 arena_t *arena) {
//   (void)arena;
//   if (arguments->count != 2) {
...
//   if (arguments->count < 2) {
//     throw(result_void_position_t, ERROR_CODE_RUNTIME_ERROR, result->position,
//           "%s requires 2 arguments. Got %zu", GREATER_THAN,
//           arguments->count);
//   }
...
//  */
// const char *NEQ = "<>";
// result_void_position_t notEqual(value_t *result, const value_list_t
// *arguments,
//                                 arena_t *arena) {
//   (void)arena;
//   if (arguments->count < 2) {
...
//  */
// const char *LEQ = "<=";
// result_void_position_t lessEqual(value_t *result, const value_list_t
// *arguments,
//                                  arena_t *arena) {
//   (void)arena;
//   if (arguments->count < 2) {
...
//  * @param {number} a - The first number.
//  * @param {number} b - The second number.
//  * @returns {boolean} True if a is greater than or equal to b, false
//  otherwise.
//  * @example
//  *   (>= 6 1) ; returns true
//  */
...
//   if (arguments->count < 2) {
//     throw(result_void_position_t, ERROR_CODE_RUNTIME_ERROR, result->position,
//           "%s requires 2 arguments. Got %zu.", LOGICAL_AND,
//           arguments->count);
//   }
...
// result_void_position_t logicalOr(value_t *result, const value_list_t
// *arguments,
//                                  arena_t *arena) {
//   (void)arena;
//   if (arguments->count < 2) {
