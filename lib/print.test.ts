...
test('multi-item list', () => {
  const tests: TestCase[] = [
    ...
    ['(+ (1) 2)', [[TokenTag.OPERATOR, Operator.PLUS], [[TokenTag.NUMBER, 1]], [TokenTag.NUMBER, 2]], 'binary operator nested list'],
    ['(+ (1 (2)) 3)', [[TokenTag.OPERATOR, Operator.PLUS], [[TokenTag.NUMBER, 1], [[TokenTag.NUMBER, 2]]], [TokenTag.NUMBER, 3]], 'binary operator nested list'],
  ]
